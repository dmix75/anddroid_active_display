...
public class ActiveDisplayActivity extends Activity {
    ...
    /** Name on the ActiveDisplayUtil.DEBUG tags */
    ...
    protected void onStart() {
        ...
        Intent intent = new Intent( this,
                ActiveDisplayNotificationService.class );
    ...
    private class NotificationReceiver extends BroadcastReceiver {
        ...
        public void onReceive( Context context, Intent intent ) {
            ...
            // }
            // } else {
            // if (ActiveDisplayUtil.DEBUG) Log.d(tag, "++++ Empty Notifiations ++++");
            // }
            ...
            if ( null != sbn ) {
                ...
                View sbnView = sbn.getNotification().contentView.apply(
                        context, null );
